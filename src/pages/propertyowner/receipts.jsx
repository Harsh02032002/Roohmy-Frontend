              ...
              {filteredReceipts.map((r) => (
                <tr key={r.id} className="hover:bg-muted/40 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right space-x-2">
                    <button onClick={() => alert("Viewing receipt...")} className="size-8 rounded-lg border border-border bg-card text-muted-foreground hover:text-foreground inline-flex items-center justify-center transition-colors">
                      <Eye size={14} />
                    </button>
                    <button onClick={() => alert("Downloading receipt...")} className="size-8 rounded-lg border border-border bg-card text-muted-foreground hover:text-foreground inline-flex items-center justify-center transition-colors">
                      <Download size={14} />
                    </button>
                  </td>
                </tr>
