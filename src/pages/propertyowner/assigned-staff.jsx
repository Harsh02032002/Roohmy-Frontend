...
export default function AssignedStaffPage() {
  ...
  const [staff, setStaff] = useState([
    { id: 1, name: "Suresh Kumar", role: "Chief Electrician", activeTasks: 2, rating: 4.8, phone: "+91 98765 11002", status: "On Duty" },
    { id: 2, name: "Ramesh Dev", role: "Plumber & Mason", activeTasks: 0, rating: 4.5, phone: "+91 91234 55432", status: "On Duty" },
    { id: 3, name: "Deepak Rawat", role: "Security & Guard Supervisor", activeTasks: 1, rating: 4.9, phone: "+91 99988 88776", status: "Break" }
  ]);
            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-border/60 pt-4 space-y-2 text-xs">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-primary">{s.activeTasks} Tasks</span>
                </div>
              </div>
            </div>
          </div>
