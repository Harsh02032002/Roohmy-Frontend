...
export default function OccupancyReport() {
  ...
  return (
    <PropertyOwnerLayout owner={owner} title="Occupancy Report" onLogout={() => { clearOwnerRuntimeSession(); window.location.href = "/propertyowner/ownerlogin"; }}>
      <div className="mb-8"><h1 className="font-serif text-[38px] md:text-[44px] leading-[1.05] text-foreground">Occupancy Report</h1>
      <p className="mt-1.5 text-[13.5px] text-muted-foreground">Bed occupancy analytics.</p></div>
