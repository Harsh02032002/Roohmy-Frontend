...
export default function TenantDocsPage() {
  ...
  const [docs, setDocs] = useState([
    { id: 1, name: "Amit Sharma", type: "Aadhaar Card", number: "xxxx-xxxx-8091", status: "Verified" },
    { id: 2, name: "Vijay Kumar", type: "PAN Card", number: "xxxxx-4401-A", status: "Pending Verification" }
  ]);
