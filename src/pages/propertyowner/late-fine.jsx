...
export default function LateFine() {
  ...
  return (
    <PropertyOwnerLayout owner={owner} title="Late Fine" onLogout={() => { clearOwnerRuntimeSession(); window.location.href = "/propertyowner/ownerlogin"; }}>
      <div className="mb-8"><h1 className="font-serif text-[38px] md:text-[44px] leading-[1.05] text-foreground">Late Fine</h1>
      <p className="mt-1.5 text-[13.5px] text-muted-foreground">Configure late payment penalties.</p></div>
