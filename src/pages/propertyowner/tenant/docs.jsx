    ...
    <PropertyOwnerLayout>
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-3xl font-black tracking-tight">Tenant Documentation</h1>
              </div>
              <p className="text-blue-100 font-medium max-w-xl">Manage Aadhaar, PAN, and Police Verification documents securely.</p>
            </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 min-h-[400px] flex flex-col items-center justify-center text-center">
          ...
          <p className="text-slate-500 font-medium max-w-sm mx-auto">Document verification status and uploads go here. Add your first record to get started with management.</p>
