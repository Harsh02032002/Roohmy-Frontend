    ...
    <PropertyOwnerLayout>
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-3xl font-black tracking-tight">Tenant Passbook</h1>
              </div>
              <p className="text-blue-100 font-medium max-w-xl">View individual transaction history and rent passbooks for all tenants.</p>
            </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 min-h-[400px] flex flex-col items-center justify-center text-center">
          ...
          <p className="text-slate-500 font-medium max-w-sm mx-auto">Passbook transaction records go here. Add your first record to get started with management.</p>
